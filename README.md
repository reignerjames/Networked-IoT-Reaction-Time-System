...
breakout board to the tactile switch on the breadboard. This concludes all the hardware involved. A python3 script is involved in creating the game.py script
and server.py script to create the game and an SQLite3 database to store the game data. Flask/HTML/CSS is implemented for the website.
